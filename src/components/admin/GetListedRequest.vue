        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb mb-5">
                    ...
                    <li class="breadcrumb-item active">Listed Requests</li>
                </ol>
                <div class="mt-0 mb-5">
                    <h2>Listed Requests</h2>
                ...
                <table id="listedRequest_table" class="display" style="width:100%" v-if="!loading">
                    <thead>
                        <tr>
                            <th></th>
                            <th>Name</th>
...
<script>
    ...
    export default {
        ...
        methods: {
            async getInquires() {
                try {
                    const response = await API.get('websiteApi', '/website/get-listed-request');
